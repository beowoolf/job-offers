...
public class JobMapper {
    ...
    public static Job mapFromJobDtoToJob(JobRequestDto jobRequestDto) {
        return Job.builder()
                .companyLogoUrl(jobRequestDto.getCompanyLogoThumbUrl())
    ...
    public static Job mapFromJobResponseToJob(JobResponse jobResponse) {
        return Job.builder()
                .companyLogoUrl(jobResponse.getCompanyLogoThumbUrl())
                ...
                .url("https://justjoin.it/offers/" + jobResponse.getSlug())
